...
namespace Sisus.Shared.EditorOnly
{
	...
	public static class SerializedPropertyExtensions
	{
		...
		public static object GetValue([DisallowNull] this SerializedProperty serializedProperty)
		{
			...
			#if DEV_MODE
			if(!serializedProperty.serializedObject.IsValid() || !serializedProperty.serializedObject.targetObject)
			{
				Debug.Log($"SerializedProperty.GetValue() called. Checking isArray with IsValid():{serializedProperty.serializedObject.IsValid()}, target:{serializedProperty.serializedObject.targetObject}..."); // TEMP
				return null;
			}
			#endif
