...
namespace Sisus.Init.EditorOnly.Internal
{
	...
	internal static class ScriptGenerator
	{
		...
		private static string CreateInitializer(string initializerPath, Type clientType = null, bool createBaseInitializer = false)
		{
			...
			if(parameterCount > 0)
			{
				for(int i = 0; i < parameterCount; i++)
				{
					...
					else
					{
						...
						var fieldName = parameterName ?? char.ToLowerInvariant(name[0]) + name.Substring(1);
						...
						{
							var serializableTypeName = NameOf(serializableType, namespaces);
			...
			string template = createBaseInitializer ? InitializerBaseTemplate : InitializerTemplate;

			switch(initializerType)
			{
				case InitializerType.WrapperInitializer:
					baseClassName = createBaseInitializer ? "WrapperInitializerBase" : "WrapperInitializer";
					...
					template = createBaseInitializer ? WrapperInitializerBaseTemplate : WrapperInitializerTemplate;
				...
				case InitializerType.StateMachineBehaviourInitializer:
					baseClassName = createBaseInitializer ? "StateMachineBehaviourInitializerBase" : "StateMachineBehaviourInitializer";
					humanReadableType = "state machine behaviour";
					break;
				case InitializerType.ScriptableObjectInitializer:
					baseClassName = createBaseInitializer ? "ScriptableObjectInitializerBase" : "ScriptableObjectInitializer";
					humanReadableType = "scriptable object";
					break;
				case InitializerType.Initializer:
					baseClassName = createBaseInitializer ? "InitializerBase" : "Initializer";
				...
				case InitializerType.VisualElementInitializer:
					...
					baseClassName = createBaseInitializer ? "VisualElementInitializerBase" : "VisualElementInitializer";
				...
				default:
					...
					baseClassName = createBaseInitializer ? "CustomInitializerBase" : "CustomInitializer";
