	...
	internal sealed class ServicesWindow : EditorWindow
	{
		...
		private void DrawServicesList(List<Service.ActiveServiceInfo> services)
		{
			...
			foreach(var serviceInfo in services)
			{
				...
				bool isUnityObject = !isNull && TryGetUnityObject(service, false, out unityObject);
				bool isActive = !isNull && (!isUnityObject || (unityObject && (unityObject is not Behaviour behaviour || behaviour.isActiveAndEnabled)));
