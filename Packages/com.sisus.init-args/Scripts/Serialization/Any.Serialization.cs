...
namespace Sisus.Init.Serialization
{
	...
	[Serializable, EditorBrowsable(EditorBrowsableState.Never)]
	internal abstract class Serializable<T> : IValueProvider<object>, IComparable, IComparable<T>, IConvertible, IEquatable<T> where T : IComparable, IComparable<T>, IConvertible, IEquatable<T>
	{
		public T value;
