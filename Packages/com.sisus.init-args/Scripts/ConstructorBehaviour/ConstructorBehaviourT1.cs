...
namespace Sisus.Init
{
	...
	/// </para>
	/// </summary>
	/// <typeparam name="TArgument"> Type of the object that the <see cref="UnityEngine.Component"/> depends on. </typeparam>
		...
		#endif
	{
		...
		/// </para>
		/// </summary>
		/// <param name="argument"> The argument passed to this <see cref="UnityEngine.Component"/>. </param>
		...
		protected virtual string GetInitArgumentClassMemberName()
		{
			...
			catch
			{
				...
				{
					if(initializerType.GetNestedType(InitArgumentMetadataClassName) is not { } init)
					{
						continue;
					}
