...
namespace Sisus.Init
{
	...
	/// or <see cref="AddComponent">added</see>
	...
	/// </para>
	/// </summary>
	/// <typeparam name="TFirstArgument"> Type of the first object that the <see cref="UnityEngine.Component"/> depends on. </typeparam>
	/// <typeparam name="TSecondArgument"> Type of the second object that the <see cref="UnityEngine.Component"/> depends on. </typeparam>
	/// <typeparam name="TThirdArgument"> Type of the third object that the <see cref="UnityEngine.Component"/> depends on. </typeparam>
	/// <typeparam name="TFourthArgument"> Type of the fourth object that the <see cref="UnityEngine.Component"/> depends on. </typeparam>
	/// <typeparam name="TFifthArgument"> Type of the fifth object that the <see cref="UnityEngine.Component"/> depends on. </typeparam>
	/// <typeparam name="TSixthArgument"> Type of the sixth object that the <see cref="UnityEngine.Component"/> depends on. </typeparam>
	/// <seealso cref="MonoBehaviour{TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument}"/>
	[Obsolete("ConstructorBehaviour<T...> is deprecated. Use MonoBehaviour<T...> instead.")]
		...
		#endif
	{
		...
		/// </para>
		/// </summary>
		/// <param name="firstArgument"> The first argument passed to this <see cref="UnityEngine.Component"/>. </param>
		/// <param name="secondArgument"> The second argument passed to this <see cref="UnityEngine.Component"/>. </param>
		/// <param name="thirdArgument"> The third argument passed to this <see cref="UnityEngine.Component"/>. </param>
		/// <param name="fourthArgument"> The fourth argument passed to this <see cref="UnityEngine.Component"/>. </param>
		/// <param name="fifthArgument"> The fifth argument passed to this <see cref="UnityEngine.Component"/>. </param>
		/// <param name="sixthArgument"> The sixth argument passed to this <see cref="UnityEngine.Component"/>. </param>
		...
		/// as the serialized state of the <see cref="UnityEngine.Component"/> is undefined at construction time, and many classes in Unity are not thread safe and as such
		/// are not supported being called from <see cref="UnityEngine.Component"/> constructors.
		/// </para>
		/// </summary>
