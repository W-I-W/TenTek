...
namespace Sisus.Init
{
	...
	public abstract class MonoBehaviour<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument, TSeventhArgument, TEighthArgument, TNinthArgument, TTenthArgument, TEleventhArgument, TTwelfthArgument> : MonoBehaviourBase, IInitializable<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument, TSeventhArgument, TEighthArgument, TNinthArgument, TTenthArgument, TEleventhArgument, TTwelfthArgument>
	{
		...
		{
			var firstArgument = await Service.GetForAsync<TFirstArgument>(this, context);
			var secondArgument = await Service.GetForAsync<TSecondArgument>(this);
			var thirdArgument = await Service.GetForAsync<TThirdArgument>(this);
			var fourthArgument = await Service.GetForAsync<TFourthArgument>(this);
			var fifthArgument = await Service.GetForAsync<TFifthArgument>(this);
			var sixthArgument = await Service.GetForAsync<TSixthArgument>(this);
			var seventhArgument = await Service.GetForAsync<TSeventhArgument>(this);
			var eighthArgument = await Service.GetForAsync<TEighthArgument>(this);
			var ninthArgument = await Service.GetForAsync<TNinthArgument>(this);
			var tenthArgument = await Service.GetForAsync<TTenthArgument>(this);
			var eleventhArgument = await Service.GetForAsync<TEleventhArgument>(this);
			var twelfthArgument = await Service.GetForAsync<TTwelfthArgument>(this);
